...
import { get_number_of_pools_function, get_pool_function } from './ref/ref_functions'
// ===================================
console.log("============================")
...
console.log(await get_number_of_pools_function())
console.log(await get_pool_function(5767))
console.log("============================")