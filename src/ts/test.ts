...
import { get_nearClient_accountId } from "./fastintear/accountId";
import {
...
console.log("==========================================================");
const accountId = get_nearClient_accountId()
console.log(accountId)
const storage_balance = await ref_storage_balance_of_function(accountId)
console.log("STORAGE BALANCE:", storage_balance.available, storage_balance.total)
console.log("==========================================================");
